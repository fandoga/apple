// In Next.js static imports must be relative to the file (or use strings
// for files served from the public folder). Public assets are available
// at `/assets/...`, so we reference them as plain strings to avoid
